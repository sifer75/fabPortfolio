    ...
    return (
        <div
            className={`flex flex-col transition-all relative duration-700 overflow-hidden ease-in-out bg-white ${
                menuIsOpen
                    ? "h-full w-60"
                    : "h-16 w-16 rounded-[48px] ml-4 mt-4"
            }`}
        >
            <div
                className={`transition-all relative duration-500 ease-in-out p-4 bg-yellow-50 h-16 w-16 rounded-full aspect-square flex flex-col justify-center items-center`}
            >
                <div
            ...
            <div
                className={`${
                    menuIsOpen ? "" : "h-0"
                } h-full w-full flex flex-col gap-6 px-5`}
            >
